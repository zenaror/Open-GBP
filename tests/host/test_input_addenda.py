...
class TheFrozenThingsAreUntouched(unittest.TestCase):
    ...
    def test_nothing_under_the_untouchable_paths_changed(self):
        ...
        changed = guards.changed_between(FROZEN_COMMIT, guards.CHECKPOINTS_CLOSED_AT, ["src", "poc", "tools", "Makefile", "stimulus"])   # Issue #29: tracked AND untracked, one implementation
        ...
        changed2 = guards.changed_between(FROZEN_COMMIT, guards.CHECKPOINTS_CLOSED_AT, ["captures/fixtures"])   # Issue #29: tracked AND untracked, one implementation
