...
class NothingElseMoved(unittest.TestCase):
    ...
    def test_only_the_four_files_of_issue_27_moved_under_the_frozen_paths(self):
        ...
        changed = guards.changed_between(BASE, guards.CHECKPOINTS_CLOSED_AT, ["src", "poc", "tools", "Makefile", "stimulus", "captures/fixtures", "docs/protocol", "docs/hardware"])   # Issue #29: tracked AND untracked, one implementation
