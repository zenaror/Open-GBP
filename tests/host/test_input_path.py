...
class TheStaticAttemptIsStatedOnceAndStaysOpen(unittest.TestCase):
    ...
    def test_the_findings_use_the_keypad_namespace_and_mint_no_hardware_id(self):
        ...
        self.assertEqual(hw, 272)   # GBP-HW-261…265: RUN 14 / RUN 15 (Issue #24); 266…271: RUN 16 / 17 / 18 (Issue #33)   # 272: Issue #46 (the CONTROL bit 0x02 split, FACT for the split / HYPOTHESIS for the cause)
        ...
        for p in (ROADMAP, HANDOFF):
            self.assertNotRegex(read(p), r"GBP-HW-27[3-9]|GBP-HW-2[8-9]\d|GBP-HW-[3-9]\d\d")
