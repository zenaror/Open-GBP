...
class NothingFrozenMovedAndNothingWasMinted(unittest.TestCase):
    ...
    def test_nothing_under_the_untouchable_paths_changed(self):
        ...
        changed = guards.changed_between(BASE, guards.CHECKPOINTS_CLOSED_AT, ["src", "poc", "tools", "Makefile", "stimulus", "captures/fixtures"])   # Issue #29: tracked AND untracked, one implementation
