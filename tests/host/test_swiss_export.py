...
class FrozenSlotsCannotBeDestroyed(unittest.TestCase):
    ...
    def test_the_real_manifest_freezes_the_two_slots_the_records_name(self):
        ...
        # Issue #110 (2026-09-24): the real-cartridge image, frozen before its export (§V25.9)
        self.assertEqual(rows["20-game"], "2e73a39d931ee161df1144b4bfb01b358e21acb3ea5ceb3ede9a366378b76725")
        # Issue #113 (2026-09-24): the second attempt's image, frozen before its export (§V26.9)
